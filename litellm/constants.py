...
# Audio token calculation constants
DEFAULT_AUDIO_TOKENS_PER_SECOND = int(os.getenv("DEFAULT_AUDIO_TOKENS_PER_SECOND", 50))
DEFAULT_PCM16_BYTES_PER_SAMPLE = int(os.getenv("DEFAULT_PCM16_BYTES_PER_SAMPLE", 2))
DEFAULT_PCM16_SAMPLE_RATE = int(os.getenv("DEFAULT_PCM16_SAMPLE_RATE", 16000))
